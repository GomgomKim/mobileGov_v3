console.log("START to load MDHAdapter.3.1.1.min.js");
...
MDHDevice = new function () {
	...
	this.GPS.watchPosition = function (a, b, c) {
		if (c) {
			if (c.frequency < 0 || isNaN(c.frequency)) {
				b(MDHMgr.MDH_INVALID_ARGUMENT);
				return null
			}
			if (c.timeout < 0 || isNaN(c.timeout)) {
				b(MDHMgr.MDH_INVALID_ARGUMENT);
				return null
			}
		}
	...
	this.Vibrator = new function () {
		this.run = function (a, c, d) {
			...
			MDHMgr.exec("Vibrator.run", a, c, d)
		}
	};
	this.Compass = new function () {
		...
		this.watchCompass = function (b, d, e) {
			var f;
			if (!e.frequency) {
				d(MDHMgr.MDH_INVALID_ARGUMENT);
				return -1
			} else {
				f = e.frequency
			}
			...
			MDHMgr.exec("Compass.start", function () {}, function () {}, e);
			return setInterval(function () {
				MDHDevice.Compass._getCurrentCompass(b, d, e)
			}, f)
		};
		this.clearWatch = function (b) {
			MDHMgr.exec("Compass.stop", function () {}, function () {});
...
MDHStorage = new function () {
	...
	this.FileMgr = new function () {
		...
		this.reader_onprogress = function (c, a) {
			this.fileReaders[c].result = decodeURIComponent(a);
	...
	this.File = new function () {
		...
		this.remove = function (a, c, b) {
			MDHStorage.FileMgr.removeFileWriter(b);
			MDHMgr.exec("File.remove", a, c, {
				filepath: b
			})
		};
...
MDHUtil = new function () {
	...
	this.Browser = new function () {
		this.startLoadingBar = function (a) {
			MDHMgr.exec("Browser.startLoadingBar", function () {}, function () {}, a)
		};
	...
	this.Map = new function () {
		this.AnnotationDetailPosBody = 0;
		this.AnnotationDetailPosHeader = 1;
		this.AnnotationDetailPosFooter = 2;
		this.AnnotationDetailTypeNormal = 0;
		this.AnnotationPinColorRed = 0;
		this.ViewTypeStandard = 0;
		this.ViewTypeSatellite = 1;
		this.ViewTypeHybrid = 2;
		this.CallBackTypeOnCapture = 0;
		this.CallBackTypeOnClickAnnotation = 1;
		this.show = function (a, c, b) {
			MDHMgr.exec("MDHMap.show", a, c, b)
		};
		this.createHelper = function () {
			return new MDHUtil.Map.MapHelper()
		};
		this.MapHelper = function () {
			this.data = new Object()
		};
		this.MapHelper.prototype = {
			setTitle: function (a) {
				this.data.title = a
			},
			...
			setEnableCapture: function (a) {
				this.data.enableCapture = a
			},
			enableUserLocation: function (a) {
				this.data.userLocation = a
			},
			setViewLocation: function (b, a) {
				this.data.viewLoc = b;
				this.data.viewRange = a
			},
			addAnnotation: function (a) {
				if (this.data.annotations == undefined) {
					this.data.annotations = new Array()
				}
				this.data.annotations.push(a.data)
			},
			show: function (a, b) {
				MDHUtil.Map.show(a, b, this.data)
			},
			createAnnotation: function () {
				return new MDHUtil.Map.Annotation(this)
			}
		};
		this.Annotation = function (a) {
			this.data = new Object();
			if (a != undefined) {
				a.addAnnotation(this)
			}
		};
		this.Annotation.prototype = {
			...
			setSubtitle: function (a) {
				this.data.subtitle = a
			},
			setTag: function (a) {
				this.data.tag = a
			},
			setEnableClick: function (a) {
				this.data.enableClick = a
			},
			setPinColor: function (a) {
				this.data.pinColor = a
			},
			setDetail: function (a) {
				this.data.detail = a.data
			},
			createDetail: function () {
				return new MDHUtil.Map.AnnotationDetail(this)
			}
		};
		this.AnnotationDetail = function (a) {
			this.data = new Array();
			if (a != undefined) {
				a.setDetail(this)
			}
		};
		this.AnnotationDetail.prototype = {
			addItem: function (a, c, b, d) {
				item = new Object();
				if (d == undefined) {
					d = MDHUtil.Map.AnnotationDetailTypeBody
				}
				if (b == undefined) {
					b = MDHUtil.Map.AnnotationDetailTypeNormal
				}
				item.key = a;
				item.value = c;
				opt = new Object();
			...
			addHeader: function (a) {
				this.addItem("", a, MDHUtil.Map.AnnotationDetailTypeNormal, MDHUtil.Map.AnnotationDetailPosHeader)
			},
			addFooter: function (a) {
				this.addItem("", a, MDHUtil.Map.AnnotationDetailTypeNormal, MDHUtil.Map.AnnotationDetailPosFooter)
			},
			addBody: function (a, c, b) {
				this.addItem(a, c, b, MDHUtil.Map.AnnotationDetailPosBody)
			}
		}
	}
};
...
MDHUI = new function () {
	this.start = function (a, b, c) {
		...
		MDHMgr.exec("UI.start", function () {}, function () {}, c)
	};
	this.end = function () {
		MDHMgr.exec("UI.end", MDHUI.UIMgr._onSuccess, MDHUI.UIMgr._onError, {})
	};
	...
	this.setWebContentView = function () {
		...
		MDHMgr.exec("UI.setWebContentView", b, c, a)
	};
	...
	this.Container.prototype.create = function (a, b, c) {
		...
		c.uiId = this.uiId;
		MDHMgr.exec("UI.createContainer", a, b, c)
	};
	this.Container.prototype.remove = function () {
		MDHMgr.exec("UI.removeContainer", MDHUI.UIMgr._onSuccess, MDHUI.UIMgr._onError, this.uiId)
	};
	this.Container.prototype.addContainer = function (b) {
		var a = {};
		a.pUiId = this.uiId;
		a.uiId = b.uiId;
		MDHMgr.exec("UI.addContainer", MDHUI.UIMgr._onSuccess, MDHUI.UIMgr._onError, a)
	};
	this.Container.prototype.addComponent = function (b) {
		var a = {};
		a.pUiId = this.uiId;
		a.uiId = b.uiId;
		MDHMgr.exec("UI.addComponent", MDHUI.UIMgr._onSuccess, MDHUI.UIMgr._onError, a)
	};
	this.Container.prototype.setAttribute = function () {
		...
		a.uiId = this.uiId;
		MDHMgr.exec("UI.setAttribute", c, d, a)
	};
	...
	this.Component.prototype.create = function (a, b, c) {
		...
		MDHMgr.exec("UI.createComponent", a, b, c)
	};
	this.Component.prototype.remove = function () {
		...
		MDHMgr.exec("UI.removeComponent", MDHUI.UIMgr._onSuccess, MDHUI.UIMgr._onError, this.uiId)
	};
...
if ((typeof MDHBasic === "object") && (typeof MDHBasic.SEMP === "undefined") && (typeof MDHBasic.VPN === "undefined")) {
