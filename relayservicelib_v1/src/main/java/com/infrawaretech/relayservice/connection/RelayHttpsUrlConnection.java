...
public class RelayHttpsUrlConnection extends RelayUrlConnection {
	...
	@Override
	protected URLConnection setToConnection(URL url, String requestMethod) throws IOException {
